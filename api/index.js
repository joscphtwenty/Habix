...
mongoose
  .connect("mongodb+srv://joseph:josephjohn@cluster0.uihl10f.mongodb.net/")
  .then(() => {
...
app.post("/journal", async (req, res) => {
  try {
    const newEntry = new JournalEntry({ entry: req.body.entry });
    await newEntry.save();
...
app.get("/journalentrieslist", async (req, res) => {
  try {
